//! A simple CLI that wraps the gnark-ffi crate.
...
fn prove_plonk_bn254(data_dir: &str, witness_path: &str) -> ProofBn254 {
    ProofBn254::Plonk(gnark_ffi::ffi::prove_plonk_bn254(data_dir, witness_path))
}

fn prove_groth16_bn254(data_dir: &str, witness_path: &str) -> ProofBn254 {
    ProofBn254::Groth16(gnark_ffi::ffi::prove_groth16_bn254(data_dir, witness_path))
}
